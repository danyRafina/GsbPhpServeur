...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_1' => 'get5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a61Service',
            '5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_2' => 'get5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a62Service',
            '5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_3' => 'get5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a63Service',
            ...
            'c89f6532c3b4ca3342918d7f41e1b3205f6d6e34e3e5fce09543cde788601fa5_1' => 'getC89f6532c3b4ca3342918d7f41e1b3205f6d6e34e3e5fce09543cde788601fa51Service',
    ...
    /**
     * Gets the '5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_1' service.
     *
     ...
     */
    protected function get5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a61Service()
    {
        return $this->services['5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a62Service()
    {
        return $this->services['5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a63Service()
    {
        return $this->services['5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/AndroidGSB/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/AndroidGSB/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/AndroidGSB/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    /**
     * Gets the 'c89f6532c3b4ca3342918d7f41e1b3205f6d6e34e3e5fce09543cde788601fa5_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getC89f6532c3b4ca3342918d7f41e1b3205f6d6e34e3e5fce09543cde788601fa51Service()
    {
        return $this->services['c89f6532c3b4ca3342918d7f41e1b3205f6d6e34e3e5fce09543cde788601fa5_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/AndroidGSB/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'GsbCRSlam', 'user' => 'root', 'password' => 'mysql', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('bit' => 'boolean'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_f6e3a36a1daff64b0bda102a7e82f0fb55864124d0b347cb392ed2aac525964c');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f6e3a36a1daff64b0bda102a7e82f0fb55864124d0b347cb392ed2aac525964c');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f6e3a36a1daff64b0bda102a7e82f0fb55864124d0b347cb392ed2aac525964c');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/AndroidGSB/src/GSB/AndroidBundle/Entity')), 'GSB\\AndroidBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('GSBAndroidBundle' => 'GSB\\AndroidBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/var/www/AndroidGSB/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/AndroidGSB/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('c89f6532c3b4ca3342918d7f41e1b3205f6d6e34e3e5fce09543cde788601fa5_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/AndroidGSB/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/AndroidGSB/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/AndroidGSB/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/AndroidGSB/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/AndroidGSB/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/AndroidGSB/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/AndroidGSB/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_1'), 1 => $this->get('5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_2'), 2 => $this->get('5b72e910561d35fa7f05e43cf2677f111f99b480e838335e16d3356c67e3b1a6_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/AndroidGSB/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/AndroidGSB/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/AndroidGSB/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/AndroidGSB/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/AndroidGSB/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/AndroidGSB/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/AndroidGSB/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/AndroidGSB/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/AndroidGSB/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/AndroidGSB/src/GSB/AndroidBundle/Resources/views', 'GSBAndroid');
        $instance->addPath('/var/www/AndroidGSB/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/var/www/AndroidGSB/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/AndroidGSB/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/AndroidGSB/app/Resources/views');
        $instance->addPath('/var/www/AndroidGSB/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('72d5f25e44147d109c3b2e69310c3278ed');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/AndroidGSB/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/AndroidGSB/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/AndroidGSB/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/AndroidGSB/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/AndroidGSB/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/AndroidGSB/app/cache/dev',
            'kernel.logs_dir' => '/var/www/AndroidGSB/app/logs',
            'kernel.bundles' => array(
                ...
                'GSBAndroidBundle' => 'GSB\\AndroidBundle\\GSBAndroidBundle',
            ...
            'locale' => 'en',
            'secret' => '72d5f25e44147d109c3b2e69310c3278ed',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => '/var/www/AndroidGSB/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => '72d5f25e44147d109c3b2e69310c3278ed',
            ...
            'session.save_path' => '/var/www/AndroidGSB/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/var/www/AndroidGSB/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/AndroidGSB/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/AndroidGSB/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/AndroidGSB/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/AndroidGSB/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/AndroidGSB/app/../web',
            'assetic.write_to' => '/var/www/AndroidGSB/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/AndroidGSB/app/cache/dev/doctrine/orm/Proxies',
